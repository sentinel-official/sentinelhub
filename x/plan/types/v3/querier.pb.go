...
func (*QueryPlansRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_95148439924fd0d0, []int{0}
}
...
func (*QueryPlansForProviderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_95148439924fd0d0, []int{1}
}
...
func (*QueryPlanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_95148439924fd0d0, []int{2}
}
...
func (*QueryPlansResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_95148439924fd0d0, []int{3}
}
...
func (*QueryPlansForProviderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_95148439924fd0d0, []int{4}
}
...
func (*QueryPlanResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_95148439924fd0d0, []int{5}
}
...
func init() {
	proto.RegisterType((*QueryPlansRequest)(nil), "sentinel.plan.v3.QueryPlansRequest")
	proto.RegisterType((*QueryPlansForProviderRequest)(nil), "sentinel.plan.v3.QueryPlansForProviderRequest")
	proto.RegisterType((*QueryPlanRequest)(nil), "sentinel.plan.v3.QueryPlanRequest")
	proto.RegisterType((*QueryPlansResponse)(nil), "sentinel.plan.v3.QueryPlansResponse")
	proto.RegisterType((*QueryPlansForProviderResponse)(nil), "sentinel.plan.v3.QueryPlansForProviderResponse")
	proto.RegisterType((*QueryPlanResponse)(nil), "sentinel.plan.v3.QueryPlanResponse")
}

func init() { proto.RegisterFile("sentinel/plan/v3/querier.proto", fileDescriptor_95148439924fd0d0) }

var fileDescriptor_95148439924fd0d0 = []byte{
	// 575 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryServiceClient) QueryPlans(ctx context.Context, in *QueryPlansRequest, opts ...grpc.CallOption) (*QueryPlansResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sentinel.plan.v3.QueryService/QueryPlans", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) QueryPlansForProvider(ctx context.Context, in *QueryPlansForProviderRequest, opts ...grpc.CallOption) (*QueryPlansForProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sentinel.plan.v3.QueryService/QueryPlansForProvider", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) QueryPlan(ctx context.Context, in *QueryPlanRequest, opts ...grpc.CallOption) (*QueryPlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sentinel.plan.v3.QueryService/QueryPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueryService_QueryPlans_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sentinel.plan.v3.QueryService/QueryPlans",
	}
...
func _QueryService_QueryPlansForProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sentinel.plan.v3.QueryService/QueryPlansForProvider",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _QueryService_QueryPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sentinel.plan.v3.QueryService/QueryPlan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _QueryService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "sentinel/plan/v3/querier.proto",
}
