module github.com/sentinel-official/sentinelhub/v12

go 1.23.0

replace (
	github.com/99designs/keyring => github.com/cosmos/keyring v1.2.0
	github.com/cometbft/cometbft => github.com/sentinel-official/cometbft v0.37.19-0.20260124120127-dd53245b04e1
